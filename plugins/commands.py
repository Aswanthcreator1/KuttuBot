...
from pyrogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton, Message, ReplyKeyboardMarkup
...
async def start(client, message: Message):
    ...
    if not await is_subscribed(message.from_user.id, client):
        ...
        subdel=await client.send_message(
            ...
            text="**<b>⚠️ Pʟᴇᴀsᴇ 〄 Jᴏɪɴ Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ 〄 To Usᴇ Mᴇ !!.Aғᴛᴇʀ Jᴏɪɴᴇᴅ Cʟɪᴄᴋ Oɴ ↻ Tʀʏ Aɢᴀɪɴ Bᴜᴛᴛᴏɴ Yᴏᴜ Wɪʟʟ Gᴇᴛ Fɪʟᴇ.</b>**",
            reply_markup=InlineKeyboardMarkup(btn),
